...
// (e.g. "--bypass=<platform>/<agent>/<task>") instead of filling in
// real values, we MUST reject it. These tokens should never appear
// in a real identifier.
...
// "agent_research" is not mistakenly rejected.
...
// required format: <platform>/<agent>/<task>
//
...
//     "platform", "agent", "task", "xxx", "foo", "todo", ...
